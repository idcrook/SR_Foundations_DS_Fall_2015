...
```{r}
setwd("~/projects/Classes/FoundationsOfDataScience_sliderule/github/part4_data_wrangling/part4.1_dplyr")
# load packages
...
##flights_sqlite <- copy_to(my_db, hflights, temporary = FALSE, indexes = list(c("Year", "Month", "DayOfMonth"), "UniqueCarrier", "TailNum"))
