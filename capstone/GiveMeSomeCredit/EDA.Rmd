...
View output [EDA.html](https://dpcrook.github.io/SR_Foundations_DS_Fall_2015/capstone/GiveMeSomeCredit/EDA.html).
...
for (i in seq_along(deciles_age)){
  pct_delinquent[i] <- mean(deciles_age[[i]]$SeriousDlqin2yrs)
}
# results
...
for (i in seq_along(deciles_NumberOfDependents)){
  pct_delinquent[i] <- mean(deciles_NumberOfDependents[[i]]$SeriousDlqin2yrs)
}
# results
...
for (i in seq_along(deciles_DebtRatio)){
  pct_delinquent[i] <- mean(deciles_DebtRatio[[i]]$SeriousDlqin2yrs)
}
# results
...
for (i in seq_along(deciles_MonthlyIncome)){
  pct_delinquent[i] <- mean(deciles_MonthlyIncome[[i]]$SeriousDlqin2yrs)
}
# results
...
for (i in seq_along(deciles_MonthlyExpenses)){
  pct_delinquent[i] <- mean(deciles_MonthlyExpenses[[i]]$SeriousDlqin2yrs)
}
# results
...
for (i in seq_along(deciles_NetMonthlySurplus)){
  pct_delinquent[i] <- mean(deciles_NetMonthlySurplus[[i]]$SeriousDlqin2yrs)
}
# results
...
for (i in seq_along(deciles_NumberRealEstateLoansOrLines)){
  pct_delinquent[i] <- mean(deciles_NumberRealEstateLoansOrLines[[i]]$SeriousDlqin2yrs)
}
# results
...
for (i in seq_along(deciles_NumberOfOpenCreditLinesAndLoans)){
  pct_delinquent[i] <- mean(deciles_NumberOfOpenCreditLinesAndLoans[[i]]$SeriousDlqin2yrs)
}
# results
...
for (i in seq_along(deciles_RevolvingUtilizationOfUnsecuredLines)){
  pct_delinquent[i] <- mean(deciles_RevolvingUtilizationOfUnsecuredLines[[i]]$SeriousDlqin2yrs)
}
# results
...
for (i in seq_along(deciles_NumberOfTime60.89DaysPastDueNotWorse)){
  pct_delinquent[i] <- mean(deciles_NumberOfTime60.89DaysPastDueNotWorse[[i]]$SeriousDlqin2yrs)
}
# results
...
for (i in seq_along(deciles_NumberOfTime30.59DaysPastDueNotWorse)){
  pct_delinquent[i] <- mean(deciles_NumberOfTime30.59DaysPastDueNotWorse[[i]]$SeriousDlqin2yrs)
}
# results
...
for (i in seq_along(deciles_NumberOfTimes90DaysLate)){
  pct_delinquent[i] <- mean(deciles_NumberOfTimes90DaysLate[[i]]$SeriousDlqin2yrs)
}
# results
...
for (i in seq_along(deciles_ConsolidatedNumberOfDaysPastDue)){
  pct_delinquent[i] <- mean(deciles_ConsolidatedNumberOfDaysPastDue[[i]]$SeriousDlqin2yrs)
}
# results
...
png("feature_bucketed_discr.png", width=12, height=24, units="in", res=100)
